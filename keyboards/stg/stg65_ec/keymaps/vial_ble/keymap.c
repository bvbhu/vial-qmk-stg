...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // clang-format off
    [0] = LAYOUT(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_BSPC, BLE_SW1,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_ENT,  KC_BSLS, KC_PGUP,
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS, BLE_SW1, BLE_SW2, BLE_SW3, RF_TOG,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, USB_TOG, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
...
void lpm_set_unused_pins_to_input_analog(void)
{
    ...
    palSetLineMode(B12, PAL_MODE_INPUT_ANALOG);
