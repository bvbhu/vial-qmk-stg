 ...
 *
 * 大小由 analog_core.h 的 ANALOG_PERSIST_SIZE 按矩阵尺寸自动推导，板级 config.h
 * 无需参与；ANALOG_ENABLE 关闭时为 0，EEPROM 布局与原版完全一致。
...
#ifdef ANALOG_ENABLE
#    include "analog/analog_core.h" // COMMON_VPATH 由 build_vial.mk 在 ANALOG_ENABLE 时提供
